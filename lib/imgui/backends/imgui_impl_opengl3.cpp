...
#include <OpenGL/gl3.h> // For modern OpenGL (OpenGL 3.2+ Core Profile) on macOS
// If you were targeting older OpenGL or a compatibility profile, you might use <OpenGL/gl.h>
// but for "OpenGL3" backend, gl3.h is appropriate.
#endif
